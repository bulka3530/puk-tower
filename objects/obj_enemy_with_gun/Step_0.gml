...
if (collision_line(x, y-64, x + 250, y-64, obj_player, false, true) and cooldown <= 0) {
	instance_create_layer(x,y-64,"Instances",obj_hurt_bullet_right)
	cooldown = 100
}
if (collision_line(x, y-64, x - 250, y-64, obj_player, false, true) and cooldown <= 0) {
	instance_create_layer(x,y-64,"Instances",obj_hurt_bullet_left)
	cooldown = 100
}
cooldown -= 1